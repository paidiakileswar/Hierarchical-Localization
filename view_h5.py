...
def explore_matches_h5(file_path):
    ...
    with h5py.File(file_path, 'r') as f:
        ...
        # Explore matches and matching scores within the group
        for group_name in image_group.keys():
            subgroup = image_group[group_name]
            
            if isinstance(subgroup, h5py.Group):
                print(f"\n'{group_name}' is a group. It contains:")
